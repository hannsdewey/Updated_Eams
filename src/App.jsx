  ...
  return (
    <Router>
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          <Routes>
            <Route path="/" element={<Dashboard />} /> {/* Set default route */}
            <Route path="/dashboard" element={<Dashboard />} />
            <Route path="/attendance" element={<h2>Attendance Page Content</h2>} />
            <Route path="/shift-schedule" element={<h2>Shift Schedule Content</h2>} />
            <Route path="/leave-request" element={<h2>Leave Request Content</h2>} />
